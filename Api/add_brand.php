...
class InsertDetails{
    function startInsertDetails(){
        ...
        $response = array();
        $brand_main_catagory  = $_POST['brand_main_catagory'];
        $brand_sub_catagory  = $_POST['brand_sub_catagory'];
        ...
        try{
            ...
            $sqlInsert = "INSERT INTO brand (brand_id, catagory_id, sub_catagory_id, brand_Name,
 brand_Entry_By, brand_Input_Time) 
 VALUES (0, '$brand_main_catagory', '$brand_sub_catagory', '$brand_name', '$Entry_By', '$input_Time')";
            $conn->exec($sqlInsert);
