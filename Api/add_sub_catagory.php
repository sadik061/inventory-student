...
class InsertDetails{
    function startInsertDetails(){
        ...
        $response = array();
        $sub_main_catagory   = $_POST['sub_main_catagory'];
        ...
        try{
            ...
            $sqlInsert = "INSERT INTO sub_catagory (sub_catagory_id, catagory_id, sub_catagory_Name, sub_catagory_Entry_By,
 sub_catagory_Input_Time) 
 VALUES (0, '$sub_main_catagory', '$sub_catagory', '$Entry_By', '$input_Time')";
            $conn->exec($sqlInsert);
