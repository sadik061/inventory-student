                ...
                <div class="col-md-12">
                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Add new Entry</a></li>
                            <li role="presentation"><a href="#Show" aria-controls="Show" role="tab" data-toggle="tab">Entry list</a></li>
                        </ul>
